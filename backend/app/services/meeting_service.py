...
class MeetingService:
    ...
    async def create_meeting_from_transcript(
        ...
        # 2. Extract title logic: use user provided title, fallback to LLM generated, fallback to default
        # 3. Create the meeting and tasks in a single atomic transaction
        meeting = Meeting(
